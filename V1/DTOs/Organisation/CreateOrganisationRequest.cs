...
namespace CoviIDApiCore.V1.DTOs.Organisation
{
    ...
    {
        [JsonProperty("event_id")] public string Id { get; set; }
        [JsonProperty("event_type")] public string Type { get; set; }
    ...
    public class Definition
    {
        [JsonProperty("id")] public string Id { get; set; }
        [JsonProperty("title")] public string Title { get; set; }
        [JsonProperty("fields")] public List<Fields> Fields { get; set; }
    }
    ...
    public class Answer
    {
        ...
        [JsonProperty("field")] public AnswerFields Field { get; set; }
    ...
    {
        [JsonProperty("form_id")] public string Id { get; set; }
